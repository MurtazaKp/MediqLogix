...
export const TeamTwo = () => {
  return (
    <>
      <p>
        Somesh oversees product development, client engagements, and technology
        strategy at MediQlogix. Before joining MediQlogix, Somesh worked in
        various technology management positions for companies like Goldman
        Sachs, IBM Global Services, and Hitachi, where he managed the rollout of
        large-scale and mission-critical initiatives worth millions of dollars.
        With over eighteen years of experience in a wide array of technologies
        and platforms, Somesh is well-versed in architecture design, project
        management, business development, process reengineering, and strategic
        planning across a wide range of industries including banking, media,
        travel, and government.
      </p>
      <p>
        Somesh holds an MBA degree from Goizueta Business School at Emory
        University, Atlanta, GA, an MS from Carnegie Mellon University,
        Pittsburgh, PA, and a B.Tech. from the Indian Institute of Technology,
        New Delhi, India. He is a certified sailor, loves to play tennis, and
  ...
  return (
    <>
      ...
      <p className="HelveticaNeue-Regular text-[14.5px] leading-5">
        ...
        performance improvement and physician, administration, and board
        leadership for member hospitals. He served as national medical director
        for VHA’s nationally acknowledged Intensive Care Collaborative. He was
        the National Medical Director for VHA’s Surgical Quality Improvement
        Collaborative, “Transformation of the OR” which he helped design and
        initiate. He led the National Physician Leadership Council for more than
        100 physician Executives.
      </p>
      <p className="HelveticaNeue-Regular text-[14.5px] leading-5">
        From 2000 to 2004, Dr Dunn was Senior Vice President and Chief Medical
        Officer of Meridian Health, a large multi-hospital system on the east
        coast. He also served as President of one of that system’s hospitals. He
        was responsible for quality and clinical performance, strategic growth,
        and physician development. He designed and implemented clinical service
        lines, driving clinical, financial, and quality improvement. He leads
      ...
      <div>
        <p>
          ...
          attain University Hospital accreditation for its flagship hospital. Dr
          Dunn’s prior clinical, academic, and administrative leadership
          includes:
        </p>
        <ul className="list-disc ps-5">
          <li className="text-primary-green">
            <p className="text-white">
              Professor and Chief of Pediatric Cardiac Surgery at Temple
              University and St Christopher’s Hospital for Children
            </p>
          </li>
          <li className="text-primary-green">
            <p className="text-white">
              Director of The Pediatric Heart Institute at St Christopher’s
              Hospital for Children
            </p>
          </li>
          <li className="text-primary-green">
            <p className="text-white">
              Chair, Society of Thoracic Surgeons Post Graduate Education
              Program
            </p>
          </li>
          <li className="text-primary-green">
            <p className="text-white">
              Editor of two Cardiac Surgery textbooks and over 40 juried papers
            </p>
          </li>
        </ul>
      </div>
      <p>
        Jeff was educated at Rensselaer Polytechnic Institute and Albany Medical
        College. His General and Cardiac Surgical training was at the University
        of Michigan and the Great Ormond Street Hospital for Sick Children,
        London. He is boarded in Thoracic and Cardiovascular Surgery.
      </p>
      <p>
        He is a member of the American College of Physician Executives, The
        American Association of Health Care Executives, and The Society of
        Thoracic Surgeons and is a Fellow of the American College of Surgeons.
        He has served on the New Jersey State Department of Health Quality
        Committee and the NJ Hospital Association Quality Committee. He has
        received numerous honors and recognitions including Who’s Who in America
        and in the World, The Legion of the Four Chaplains Award, and The
        American Heart Association of Pennsylvania Physician of the Year Award.
        Recently, Dr Dunn was named Vice president and President-elect leader of
        the Jackson Laboratory National Council.
      </p>
    </>
  );
};
  ...
  return (
    <>
      <p>
        ...
        abreast of industry innovations to assist organizations with initiatives
        to improve their clinical and financial performance.
      </p>
      <p>
        Kathy developed and led a successful national surgical improvement
        program for VHA, INC. which resulted in decreased surgical complications
        and improvements in member hospitals’ financial performance as well as
        coordinated and led performance improvement teams. Before this role, she
        served as Administrative Manager of Surgical Services for Baptist
        Hospital in Nashville, Tennessee with responsibilities including
        standardization, process improvement, clinical project coordination,
        information system, and materials management projects for a surgical
        caseload of more than 30,000 annually.
      </p>
      <p>
        Kathy has a Nursing degree from Tennessee State University and a
        Bachelor of Science degree in Management from Trevecca University in
        Nashville, Tennessee. Kathy has participated in various National
        Peri-operative Councils and task forces and is active in numerous civic
        endeavors such as Habitat for Humanity and Special Olympics.
      </p>
    </>
  );
};
...
export const TeamSix = () => {
  return (
    <>
      <p>
        Larry Deem is an international business development professional with
        over 12 years of experience working in a wide variety of industries. Mr.
        Deem has owned a business development, consulting, and sales management
        company for over 10 years and has a proven track record of opening new
        markets in the US and Japan. He has cultivated various high-value
        relationships in manufacturing and medical device markets.
      </p>
      <p>
        Mr. Deem has worked with the top management teams at several mid-market
        through Fortune 500 companies to plan and execute international business
        development projects. He has presented and advised several company
        boards and senior executives concerning international business
        development projects. Mr. Deem’s work has spanned a range of industries
        from automotive manufacturing to medical device and new technology
        development.
      </p>
      <p>
        Mr. Deem has a multi-disciplinary educational background and
        cross-functional experience. He received an MBA (with distinction) from
        the University of Michigan and an undergraduate degree in Engineering
        (with honors). Mr. Deem has worked in fields as diverse as engineering
        design, sales, and training. He currently enjoys running and outdoor
